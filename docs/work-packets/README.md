...
| 61 | [lane-61-social-mechanics-v3-foundation-design-prep.md](lane-61-social-mechanics-v3-foundation-design-prep.md) | none (new track, off the frozen ladder — see `docs/vision-v3.0.md` §6) | large (design doc, no code) |
