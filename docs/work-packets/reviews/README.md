...
| 22 — provenance drill-down (M3 §3.6) | unblocked (27+28 landed); boundary self-contradiction ruled via v2 review (tree holder table authorized) — **cleared for implementation** | dispatched by owner 2026-08-23 |
...
| 29 — Tier-3-rich demo run | packet written, dispatched by owner 2026-08-23 | pending delivery |
