...
| 39 — StatusChanged event class | packet written, in flight (Track A worker self-dispatched from the board) | pending delivery |
| 40 — Tier 4b design prep (avoidance) | packet written; after lane 39 | queued |
