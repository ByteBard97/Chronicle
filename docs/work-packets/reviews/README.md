...
| 22 — provenance drill-down (M3 §3.6) | packet amended per pre-dispatch review; **blocked on lanes 27+28** (replay fix, inspector real-data) | queued |
...
| 27 — dashboard supersession replay (reconstruct.ts) | packet written (lane-21 finding); Track B, **next** | dispatched by owner 2026-08-23 |
| 28 — NpcInspector → real data | packet written (lane-22 pre-dispatch finding); Track B, after 27 | queued |
