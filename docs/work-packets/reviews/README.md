...
| 14 — map → real data wiring (M3 prep) | packet written, ready for dispatch (after lane 15 lands or with boundary discipline) | pending dispatch |
| 15 — dashboard hygiene batch (Markarth label, RunPicker default, 416 backoff) | packet written, dispatched by owner 2026-08-23 | pending delivery |
| 16 — TimelineBar → real data (M3 timeline) | packet written; blocked on lane 14 landing | queued |
